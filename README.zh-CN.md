...
- 应用名称改为 ShuShuscanner，中文名为“鼠鼠小账本”
- 添加中文界面本地化
- 更新 logo 和应用图标
- 调整设置界面布局
...
- 改进 PvE 数据刷新行为
- 默认语言选项改为英文
- 默认不记录调试日志，也不会默认保存调试截图
- 扫描到本地缓存缺失的物品 ID 时，会刷新物品数据后重试
- 放宽名称扫描标记识别阈值，以适配当前游戏界面缩放
- 修复在 M+N 叠加页面搜索栏输入文字时可能崩溃的问题
